...
htmlhelp_basename = 'sandboxapidoc'
...
latex_documents = [
    (master_doc, 'sandboxapi.tex', u'sandboxapi Documentation',
...
man_pages = [
    (master_doc, 'sandboxapi', u'sandboxapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sandboxapi', u'sandboxapi Documentation',
     author, 'sandboxapi', 'Minimal, consistent Python API for building integrations with malware sandboxes.',
     'Miscellaneous'),
]
